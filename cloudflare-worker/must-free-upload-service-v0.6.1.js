// MUST Free Upload Service v0.6.1
  ...
  async fetch(req, env) {
    ...
    try {
      ...
      if ((url.pathname === "/" || url.pathname === "/health") && req.method === "GET") {
        return json({ ok: true, service: "MUST Free Upload Service", version: "0.6.1" }, 200, cors);
      }
...
function corsHeaders(origin, env) {
  ...
  // GitHub Pages sends Origin without the repository path, e.g.
  // https://f00931must-hash.github.io (not /must-resource-budget-system/).
